...
import { Lock, Mail, User as UserIcon, X, ArrowRight, Loader2, Shield } from 'lucide-react';
...
const UserLogin: React.FC<UserLoginProps> = ({ onLogin, onCancel, onAdminLoginClick }) => {
        ...
        <div className="p-8">
            ...
            <div className="mt-6 text-center space-y-4">
                ...
                <div className="relative flex py-2 items-center">
                    ...
                    <span className="flex-shrink-0 mx-4 text-gray-300 text-xs">خيارات أخرى</span>
                    <div className="flex-grow border-t border-gray-100"></div>
                </div>
