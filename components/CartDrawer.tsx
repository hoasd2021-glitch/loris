...
const CartDrawer: React.FC<CartDrawerProps> = ({
  ...
  const formatPrice = (priceInSar: number) => {
    ...
    return `$${(priceInSar / exchangeRate).toFixed(2)}`;
  };
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-y-0 left-0 max-w-md w-full flex">
        <div className="w-full bg-white shadow-2xl flex flex-col h-full transform transition-transform duration-300 ease-in-out animate-slide-in-right">
          ...
          <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50">
            <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2">
              ...
              سلة المشتريات
              <span className="bg-primary/10 text-primary text-xs px-2 py-1 rounded-full">{items.length} منتجات</span>
            </h2>
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="font-bold text-gray-900 dir-ltr">{formatPrice(item.price * item.quantity)}</span>
                        <button
              ...
              <div>
                ...
                <div className="space-y-2">
                  {shippingOptions.map((option) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                         <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${selectedShippingId === option.id ? 'border-primary' : 'border-gray-300'}`}>
                         ...
                         <div>
                            ...
                            <p className="text-xs text-gray-500">{option.description} ({option.estimatedDays})</p>
                         </div>
                      </div>
